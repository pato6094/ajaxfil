...
function initRealTimeUpdates() {
    // Get the last booking ID on page load
    const lastRow = document.querySelector('#bookings-table-body tr:first-child');
    if (lastRow) {
        const firstCell = lastRow.querySelector('td:first-child');
        if (firstCell && firstCell.textContent !== 'Nessuna prenotazione trovata') {
            // We need to get the actual booking ID, not the row number
            getLastBookingId();
        }
    }
...
function showUpdateNotification() {
    ...
    indicator.innerHTML = '<i class="fas fa-check"></i> Nuova prenotazione ricevuta!';
